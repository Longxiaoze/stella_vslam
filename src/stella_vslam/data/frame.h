...
namespace feature {
class orb_extractor;
class LineFeatureTracker; // FW: // plp: add LineFeatureTracker
} // namespace feature
...
public:
    ...
    // plp: add img_seg_mask for Monocular frame + planar segmentation
    ...
    // plp: add line_extractor for Monocular frame + planar segmentation + line segments extractor
    frame(const cv::Mat &img_gray, const double timestamp, const cv::Mat &img_seg_mask,
        feature::orb_extractor *extractor, bow_vocabulary *bow_vocab,
    ...
    // plp: add line_extractor for Monocular frame + line segments extractor
    frame(const cv::Mat &img_gray, const double timestamp,
        feature::orb_extractor *extractor, bow_vocabulary *bow_vocab,
        feature::LineFeatureTracker *line_extractor,
        camera::base *camera, const float depth_thr,
    ...
    // plp: add img_seg_mask for stereo + planar segmentation
    ...
    // plp: add line_extractor for stereo + planar segmentation + line segments extractor
    frame(const cv::Mat &left_img_gray, const cv::Mat &right_img_gray, const cv::Mat &img_seg_mask, const double timestamp,
        feature::orb_extractor *extractor_left, feature::orb_extractor *extractor_right, bow_vocabulary *bow_vocab,
    ...
    // plp: add line_extractor for Stereo frame + line segment extractor
    frame(const cv::Mat &left_img_gray, const cv::Mat &right_img_gray, const double timestamp,
        feature::orb_extractor *extractor_left, feature::orb_extractor *extractor_right, bow_vocabulary *bow_vocab,
        feature::LineFeatureTracker *line_extractor, feature::LineFeatureTracker *line_extractor_right,
        camera::base *camera, const float depth_thr,
    ...
    // plp: add img_seg_mask for RGB-D frame with planar segmentation
    ...
    // plp: add line_extractor for RGB-D frame with planar segmentation + line segments extractor
    frame(const cv::Mat &img_gray, const cv::Mat &img_depth, const cv::Mat &img_seg_mask, const double timestamp,
        feature::orb_extractor *extractor, bow_vocabulary *bow_vocab,
        feature::LineFeatureTracker *line_extractor,
        camera::base *camera, const float depth_thr,
    ...
    // plp: add line_extractor for RGB-D frame with line segments extractor
    frame(const cv::Mat &img_gray, const cv::Mat &img_depth, const double timestamp,
        feature::orb_extractor *extractor, bow_vocabulary *bow_vocab,
        feature::LineFeatureTracker *line_extractor,
        camera::base *camera, const float depth_thr,
    ...
    // plp: check if the 3D line is in the frustum
    ...
    // plp: get keypoint indices in the cell which reference point is located
    ...
    // plp: get keylines in the cell which reference point is located
    ...
    // plp: perform stereo triangulation of the keypoint
    ...
    // plp: pair of <starting point (sp), ending point (ep)>
    ...
    // plp: used for monocular / rgb-d / left of stereo
...
private:
    ...
    // plp: compute disparities from depth information in depthmap
