...
// plp: constructor set segment or not set line tracking or not
...
void map_database::clear() {
    ...
    // plp if segment is set, clear landmarks_plane
    if (_b_seg_or_not) {
...
// FW:
// plp: add line landmarks to the map database using json
void map_database::from_json(camera_database* cam_db, bow_vocabulary* bow_vocab, bow_database* bow_db,
                             const nlohmann::json& json_keyfrms, const nlohmann::json& json_landmarks,
...
// FW:
// plp: add plane landmarks to the map database
...
void map_database::register_keyframe(camera_database* cam_db, bow_vocabulary* bow_vocab, bow_database* bow_db,
    ...
    // plp: If line tracking is not used
...
// FW:
// plp: to_json for line landmarks json_landmarks_line
