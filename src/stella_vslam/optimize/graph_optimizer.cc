...
#include "stella_vslam/optimize/g2o/sim3/shot_vertex.h"
#include "stella_vslam/optimize/g2o/sim3/graph_opt_edge.h"
...
void graph_optimizer::optimize(data::keyframe* loop_keyfrm, data::keyframe* curr_keyfrm,
    ...
    // plp: this is the first type of edge
    ...
    for (auto keyfrm : all_keyfrms) {
        ...
        // plp: this is the second type of edge
...

    {
        ...
        // plp: correct position of line cloud
