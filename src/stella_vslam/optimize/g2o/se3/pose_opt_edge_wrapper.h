...
#include "stella_vslam/optimize/g2o/se3/perspective_pose_opt_edge.h"
#include "stella_vslam/optimize/g2o/se3/equirectangular_pose_opt_edge.h"

#include <g2o/core/robust_kernel_impl.h>

// FW:
// 
#include "stella_vslam/optimize/g2o/se3/pose_opt_edge_line3d_orthonormal.h" // orthonormal representation
    ...
    switch (camera_->model_type_) {
        case camera::model_type_t::Perspective: {
            ...
            if (is_monocular_) {
                ...
                // y-real: the measurement->2D pixel position in the image
                ...
                edge->pos_w_ = pos_w;
                // set vertex which is connected to this edge, Unary edge->just one vertex, id always=0
...
// plp: for line (Plücker coordinates, and orthonormal representation)
template<typename T>
        ...
        is_monocular_(obs_x_right < 0)
{
    ...
    // define a reprojection edge (Unary)
    auto edge = new stella_vslam::optimize::g2o::se3::pose_opt_edge_line3d();
